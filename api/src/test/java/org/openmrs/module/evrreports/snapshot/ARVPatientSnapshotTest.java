package org.openmrs.module.evrreports.snapshot;
...
//	private static final ConceptService conceptService = Context.getConceptService();
	 ...
	 * @see org.openmrs.module.evrreports.snapshot.PatientSnapshot#consume(org.openmrs.Obs)
	 */
	@Test
	@Ignore
	 ...
	 * @see org.openmrs.module.evrreports.snapshot.PatientSnapshot#eligible()
	 */
	@Test
	@Ignore
