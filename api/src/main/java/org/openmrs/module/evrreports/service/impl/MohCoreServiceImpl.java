...
public class MohCoreServiceImpl extends BaseOpenmrsService implements MohCoreService {
	...
	/**
	 * @see MohCoreService#getPatientEncounters(Integer, java.util.Map, org.openmrs.module.evrreports.util.MohFetchRestriction, java.util.Date)
	 */
	@Override
	...
	/**
	 * @see MohCoreService#getPatientObservations(Integer, java.util.Map, org.openmrs.module.evrreports.util.MohFetchRestriction, java.util.Date)
	 */
	@Override
