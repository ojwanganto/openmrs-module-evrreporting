...
public class MohHibernateCoreDAO implements MohCoreDAO {
	...
	/**
	 * @see MohCoreDAO#getPatientObservations(Integer, java.util.Map, org.openmrs.module.evrreports.util.MohFetchRestriction, java.util.Date)
	 */
	@Override
	...
	/**
	 * @see MohCoreDAO#getPatientObservationsWithEncounterRestrictions(Integer, java.util.Map, java.util.Map, org.openmrs.module.evrreports.util.MohFetchRestriction, java.util.Date)
	 */
	@Override
	...
	/**
	 * @see MohCoreDAO#getPatientEncounters(Integer, java.util.Map, org.openmrs.module.evrreports.util.MohFetchRestriction, java.util.Date)
	 */
	@Override
