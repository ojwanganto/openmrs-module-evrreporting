...
/**
 * Evaluates other details of vaccination
 */
@Handler(supports=VaccineDetailDataDefinition.class, order=50)
public class VaccineDetailDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        VaccineDetailDataDefinition def = (VaccineDetailDataDefinition) definition;
