...
<openmrs:htmlInclude file="/moduleResources/evrreports/js/diQuery-collapsiblePanel.js"/>
<openmrs:htmlInclude file="/moduleResources/evrreports/css/queuedReportsPortlet.css"/>
            ...
            <div class="queuedReportsSubSection">
                ...
                <div class="queuedReportsSubSectionTitle">
                    ...
                    <c:if test="${fn:length(f.value) gt 2}">
                        <span class="moreLink">
                            <button class="show_hide" href="#" rel="#${model.status}${f.key.locationId}">View ${fn:length(f.value) - 2} More</button>
                        </span>
                    </c:if>
                </div>
                ...
                <div class="queuedReportsSubSectionContent">
                    ...
                    <c:forEach var="r" items="${f.value}" varStatus="status">
                        ...
                        <c:if test="${status.index == 2 }">
                            ...
                            <div id="${model.status}${f.key.locationId}" class="extraContent">
                        </c:if>
